...
ImageButton.Image = "rbxassetid://16209506737"
...
local NotiFrame = Instance.new("Frame")
	...
	DiscordLib:Notification("Thông Báo" , "bản hack mới ra còn lỗi vài chức năng" , 6 ,16209506737 )
	DiscordLib:Notification("Thông Báo" , "Link discord Ở Phần Setting" , 6 ,16209506737 )
...
Setting:Label("dang bảo trì")

Setting:Line()

Setting:Button("Sao Chép Link discord",function()
 
 setclipboard("https://discord.com/invite/YX3Pg7XnXk")
  DiscordLib:Notification("Thông Báo" , "Đã Sao Chép Link link discord" , 10 ,16209506737 )
 end)
 ...
 game:GetService("RunService"):Set3dRenderingEnabled(true)
   ...
   Setting:Button("Giảm Lag",function()
	...
	function DiscordLib:Notification(text,text2,delays,logo)
      ...
      DiscordLib:Notification("Thông Báo" , "Bật Xong Sẽ Bị Đứng Máy 5-10 Giây" , 10 ,16209506737 )
      wait(3)
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
DiscordLib:Notification("Thông Báo" , "Hoàn Tất" , 10 ,16209506737 )
end)
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
-- Script generated * SimpleSpy - credits to exx#9394
...
DiscordLib:Notification("Thông Báo" , "Nhân Phẩm Đã Lên 1%" , 10 ,16209506737 )
  end)
...
for k,v in pairs(ListHuhu) do
    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy"..k,true) == 1 then 
        ...
        if type(v)=="string" then 
            ...
            huhu.Image = "rbxassetid://16209506737"
